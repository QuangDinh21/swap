/**
 * This file contains the functions to calculate necessary values for the APR calculation.
 * Copy from maia-univ3staker project.
 * https://github.com/Maia-DAO/univ3staker-frontend/blob/main/src/utils/tvl.ts
 */
